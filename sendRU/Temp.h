...
#define TEST_TMP_EVENT			0x0002//测试温度事件
#define READ_TMP_EVENT			0x0004//读取温度事件
#define SEND_TMP_EVENT			0x0008//发送温度数据事件
#define DELAY_EVENT				0x0010//延迟事件

#define TMP_REQUEST_CMD			0x44//协调器发送的温度需求命令，接收到之后启动TMP_TEST_EVENT事件
